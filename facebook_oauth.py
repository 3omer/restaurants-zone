...
_PROFILE_URL = 'https://graph.facebook.com/me?fields=name,email'
...
class FaceBookOauthSession(OAuth2Session):
    def __init__(self, client_id=CLIENT_ID, scope=_SCOPE, redirect_uri=_REDIRECT_URI, token=None):
            super().__init__(client_id=client_id, scope=scope, redirect_uri=redirect_uri, token=token)
